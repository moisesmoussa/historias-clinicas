...
if(((isset($_SESSION['super_administrador']) || isset($_SESSION['administrador'])) && $app['controller'] == 'usuarios' && $app['action'] == 'login') || (isset($_SESSION['general']) && $app['controller'] == 'usuarios' && $app['action'] != 'perfil' && $app['action'] != 'cambiar-clave'))
