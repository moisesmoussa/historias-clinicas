            ...
            <tr>
                <td>
                    ...
                    <table>
                        <tr>
                            <td>
                                <input type="radio" name="pubarquia_radio" value="TRUE" required>
                                <label>Sí Aplica</label>
                                <br>
                                <input type="radio" name="pubarquia_radio" value="FALSE" required>
                ...
                <td>
                    ...
                    <table>
                        <tr>
                            <td>
                                <input type="radio" name="telarquia_radio" value="TRUE" required>
                                <label>Sí Aplica</label>
                                <br>
                                <input type="radio" name="telarquia_radio" value="FALSE" required>
                                <label>No Aplica </label>
                            </td>
                            <td>
            ...
            <tr>
                <td>
                    ...
                    <table>
                        <tr>
                            <td>
                                <input type="radio" name="menarquia_radio" value="TRUE" required>
                                <label>Sí Aplica</label>
                                <br>
                                <input type="radio" name="menarquia_radio" value="FALSE" required>
                                <label>No Aplica </label>
                            </td>
                            <td>
                ...
                <td>
                    ...
                    <table>
                        <tr>
                            <td>
                                <input type="radio" name="ciclo_menstrual_radio" value="TRUE" required>
                                <label>Sí Aplica</label>
                                <br>
                                <input type="radio" name="ciclo_menstrual_radio" value="FALSE" required>
                                <label>No Aplica </label>
                            </td>
                            <td>
            ...
            <tr>
                <td>
                    ...
                    <table>
                        <tr>
                            <td>
                                <input type="radio" name="primera_relacion_radio" value="TRUE" required>
                                <label>Sí Aplica</label>
                                <br>
                                <input type="radio" name="primera_relacion_radio" value="FALSE" required>
                                <label>No Aplica </label>
                            </td>
                            <td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <table>
                        <tr>
                            <td>
                                <input type="radio" name="crecimiento_testicular_radio" value="TRUE" required>
                                <label>Sí Aplica</label>
                                <br>
                                <input type="radio" name="crecimiento_testicular_radio" value="FALSE" required>
                                <label>No Aplica </label>
                            </td>
                            <td>
