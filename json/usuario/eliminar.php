...
*/
session_start();
$msg['msg'] = 'No posee permisos para eliminar el usuario';
$msg['flag'] = 2;
...
if(isset($_SESSION['super_administrador']) || isset($_SESSION['administrador'])) {
    ...
    if(pg_query($query)){
        $msg['msg'] = 'Usuario eliminado exitosamente';
        $msg['flag'] = 1;
    } else {
        $msg['msg'] = 'Error con la base de datos, no se pudo eliminar el usuario';
        $msg['flag'] = 0;
    }
    pg_close($conexion);
}
